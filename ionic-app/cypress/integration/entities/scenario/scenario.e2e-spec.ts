...
describe('Scenario entity', () => {
  ...
  describe('navigation test with items', () => {
    ...
    it('should open Scenario view, open Scenario edit and go back', () => {
      ...
      if (scenario.rntype !== undefined && scenario.rntype !== null) {
        scenarioDetailPage.getRntypeContent().contains(scenario.rntype);
      }
      if (scenario.theme !== undefined && scenario.theme !== null) {
        scenarioDetailPage.getThemeContent().contains(scenario.theme);
      }
      ...
      if (scenario.trialType !== undefined && scenario.trialType !== null) {
        scenarioDetailPage.getTrialTypeContent().contains(scenario.trialType);
      }
  ...
  describe('creation test', () => {
    ...
    it('should create Scenario', () => {
      ...
      if (scenarioSample.cathegory !== undefined && scenarioSample.cathegory !== null) {
        scenarioUpdatePage.setCathegoryInput(scenarioSample.cathegory);
      }
      if (scenarioSample.subcat !== undefined && scenarioSample.subcat !== null) {
        scenarioUpdatePage.setSubcatInput(scenarioSample.subcat);
      }
