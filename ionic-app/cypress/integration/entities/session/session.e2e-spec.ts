...
describe('Session entity', () => {
  ...
  describe('navigation test with items', () => {
    ...
    it('should open Session view, open Session edit and go back', () => {
      ...
      if (session.sessionNumber !== undefined && session.sessionNumber !== null) {
        sessionDetailPage.getSessionNumberContent().contains(session.sessionNumber);
      }
  ...
  describe('creation test', () => {
    ...
    it('should create Session', () => {
      ...
      if (sessionSample.sessionNumber !== undefined && sessionSample.sessionNumber !== null) {
        sessionUpdatePage.setSessionNumberInput(sessionSample.sessionNumber);
      }
