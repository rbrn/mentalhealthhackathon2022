    ...
    public Optional<Scenario> partialUpdate(Scenario scenario) {
        ...
        return scenarioRepository
            ...
            .map(existingScenario -> {
                ...
                if (scenario.getCathegory() != null) {
                    existingScenario.setCathegory(scenario.getCathegory());
                }
                if (scenario.getSubcat() != null) {
                    existingScenario.setSubcat(scenario.getSubcat());
                }
