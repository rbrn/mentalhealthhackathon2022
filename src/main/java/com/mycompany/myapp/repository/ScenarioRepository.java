...
public interface ScenarioRepository extends JpaRepository<Scenario, Long> {
    ...
    @Query(
        value = "select distinct scenario from Scenario scenario left join fetch scenario.session",
    ...
    @Query("select distinct scenario from Scenario scenario left join fetch scenario.session")
    List<Scenario> findAllWithToOneRelationships();

    @Query("select scenario from Scenario scenario left join fetch scenario.session where scenario.id =:id")
