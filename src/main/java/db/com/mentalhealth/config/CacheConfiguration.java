...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, db.com.mentalhealth.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, db.com.mentalhealth.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, db.com.mentalhealth.domain.User.class.getName());
