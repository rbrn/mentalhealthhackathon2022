...
/**
 * REST controller for managing {@link db.com.mentalhealth.domain.Question}.
 */
@RestController
@RequestMapping("/api")
public class QuestionResource {
    ...
    public ResponseEntity<List<Question>> getAllQuestions(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
